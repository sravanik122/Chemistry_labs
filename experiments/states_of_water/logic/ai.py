...
def predict(
    ...
    """
    Predict compact physical parameters from input.
    """
...
def params_to_timeline(
    ...
    """
    Reconstruct temperature timeline from predicted parameters.
    """

    A = predicted_params.get("final_temperature", 0.0)
    k = predicted_params.get("energy_absorbed", 0.01)
