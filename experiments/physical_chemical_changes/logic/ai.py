...
def params_to_timeline(
    ...
    A = predicted_params.get("param_0", 1.0)
    ...
    for i in range(steps):
        ...
        progress = A * (1 - np.exp(-k * t))
        progress = clamp(progress, 0.0, 1.0)

        mass = predicted_params.get("param_2", 0.0) * progress
        energy = predicted_params.get("param_3", 0.0) * progress
    ...
    return Timeline(
        ...
        temperature_change=[0.0] * len(t_vals),
